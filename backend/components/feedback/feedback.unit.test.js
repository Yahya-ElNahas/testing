...
describe('Feedback Controller', () => {
  ...
  describe('POST /feedback', () => {
    it('should create feedback and return 201 status', async () => {
      ...
      expect(response.body).toEqual(createdFeedback);
      expect(FeedbackService.createFeedback).toHaveBeenCalledWith(feedbackData);
    });
  ...
  describe('DELETE /feedback/:feedback_id', () => {
    it('should delete feedback and return 200 status', async () => {
      ...
      expect(FeedbackService.deleteFeedback).toHaveBeenCalledWith(feedbackId);
    });
